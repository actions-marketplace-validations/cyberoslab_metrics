...
- uses: cyberoslab/metrics@latest
  with:
    config_presets: https://raw.githubusercontent.com/cyberoslab/metrics/presets/lunar-red/preset.yaml
```

Some presets are hosted on this repository on the [`@presets`](https://github.com/cyberoslab/metrics/tree/presets) branch and can be used directly by using their identifier prefixed by an arobase (`@`).
...
> ℹ️ Presets configurations use [schemas](https://github.com/cyberoslab/metrics/tree/presets/%40schema) to ensure compatibility between format changes
...
When using `cyberoslab/metrics` official releases as a GitHub Action, a prebuilt docker container image will be pulled from [GitHub Container Registry](https://github.com/users/cyberoslab/packages/container/package/metrics). It allows to significantly reduce workflow execution time.
...
<p>See <a href="https://github.com/cyberoslab/metrics/blob/master/source/templates/community/README.md">community templates guide</a> for more informations</p>
<img width="900" height="1" alt=""></td>
  </tr>
  <tr>
...
See <a href="https://github.com/cyberoslab/metrics/blob/master/README.md#%EF%B8%8F-templates">list of supported templates</a></p>
<img width="900" height="1" alt=""></td>
  </tr>
  <tr>
    <td nowrap="nowrap"><b>type:</b> <code>string</code>
...
<li>known issue: <a href="https://github.com/cyberoslab/metrics/issues/374">https://github.com/cyberoslab/metrics/issues/374</a></li>
</ul>
</li>
</ul>
<img width="900" height="1" alt=""></td>
...
<b>default:</b> yes<br></td>
  ...
  <tr>
    ...
    <td rowspan="2"><p>Use pre-built docker image from <a href="https://github.com/cyberoslab/metrics/pkgs/container/metrics">GitHub container registry</a></p>
