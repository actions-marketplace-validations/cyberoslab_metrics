...
All product and company names are trademarks™ or registered® trademarks of their respective holders.</p>
  ...
  <tr>
    <td colspan="2" align="center">
      <details open><summary>Indepth analysis (clone and analyze repositories)</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.languages.indepth.svg" alt=""></img></details>
      <details open><summary>Recently used (analyze recent activity events)</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.languages.recent.svg" alt=""></img></details>
      <details><summary>Default algorithm</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.languages.svg" alt=""></img></details>
      <details><summary>Default algorithm (with details)</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.languages.details.svg" alt=""></img></details>
...
<ul>
<li><code>owner/repo</code> (e.g. <code>cyberoslab/metrics</code>)</li>
<li><code>owner/repo@branch</code> (e.g. <code>cyberoslab/metrics@main</code>)</li>
<li><code>owner/repo@branch:commits</code> (e.g. <code>cyberoslab/metrics@main:v1.0..v1.1</code>)<ul>
...
*Example: hide HTML and CSS languages, skip cyberoslab/metrics repository*
```yml
- uses: cyberoslab/metrics@latest
  with:
    plugin_languages: yes
    plugin_languages_ignored: html, css
    plugin_languages_skipped: cyberoslab/metrics
```
