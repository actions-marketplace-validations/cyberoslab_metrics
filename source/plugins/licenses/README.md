...
This could result in compromised server!</p>
  ...
  <tr>
    <td colspan="2" align="center">
      <details open><summary>Permissions, limitations and conditions</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.licenses.svg" alt=""></img></details>
      <details open><summary>Licenses overview</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.licenses.ratio.svg" alt=""></img></details>
