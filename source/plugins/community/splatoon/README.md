...
<tr><th>Authors</th><td><a href="https://github.com/cyberoslab">@cyberoslab</a></td></tr>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.splatoon.svg" alt=""></img>
...
```bash
deno run --allow-run=deno --allow-read=profile.json --allow-write=profile.json --unstable https://raw.githubusercontent.com/cyberoslab/metrics/master/source/plugins/community/splatoon/token.ts
```
