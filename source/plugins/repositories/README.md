...
<p>⚠️ Due to limitations of using SVG images inside <code>&lt;img&gt;</code> tags, clicking on a repository card will not redirect to repository page.</p>
  ...
  <tr>
    <td colspan="2" align="center">
      <details open><summary>Featured</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.repositories.svg" alt=""></img></details>
      <details><summary>Pinned</summary><img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.plugin.repositories.pinned.svg" alt=""></img></details>
...
with:
  ...
  plugin_repositories_featured: cyberoslab/metrics
