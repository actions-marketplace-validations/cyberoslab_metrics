;(async function() {
  ...
  return new Vue({
    ...
    data: {
      ...
      docs: {
        overview: {
          link: "https://github.com/cyberoslab/metrics#-documentation",
          name: "Complete documentation",
        },
        markdown: {
          link: "https://github.com/cyberoslab/metrics/blob/master/.github/readme/partials/documentation/setup/shared.md",
          name: "Setup using the shared instance",
        },
        action: {
          link: "https://github.com/cyberoslab/metrics/blob/master/.github/readme/partials/documentation/setup/action.md",
    ...
    computed: {
      ...
      action() {
        return [
          `# Visit https://github.com/cyberoslab/metrics#-documentation for full reference`,
          `name: Metrics`,
          `on:`,
