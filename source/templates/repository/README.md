...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.repository.svg" alt=""></img>
...
*Example: render `cyberoslab/metrics` repository*
```yml
...
with:
  ...
  plugin_followup: yes
  plugin_projects: yes
  plugin_projects_repositories: cyberoslab/metrics/projects/1
