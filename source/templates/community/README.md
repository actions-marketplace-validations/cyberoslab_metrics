<table>
  ...
  Community templates are a way to use official releases of [cyberoslab/metrics](https://github.com/cyberoslab/metrics) while using templates from external repositories (owned or not).
