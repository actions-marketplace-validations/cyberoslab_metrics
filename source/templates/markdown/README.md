...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      <img src="https://github.com/cyberoslab/metrics/blob/examples/metrics.markdown.png" alt=""></img>
...
Use `config_output: json` to dump all available data for a given configuration. Power users can also directly read [metrics source code](https://github.com/cyberoslab/metrics) to know what is exposed.
...
**[✒️ Recent posts from dev.to](https://dev.to/cyberoslab)**
<table>
  <tr>
    ...
    <th>
      <a href="https://dev.to/cyberoslab/metrics-v3-0-the-ultimate-tool-to-pimp-your-github-profile-g7p">Metrics v3.0, the ultimate tool to pimp your GitHub profile!</a>
    </th>
  </tr>
  <tr>
    <td>
...
<img src="https://github.com/cyberoslab/metrics/blob/examples/.cache/example-languages-pdf.svg">
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/cyberoslab/metrics/examples/metrics.markdown.template.md
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/cyberoslab/metrics/master/source/templates/markdown/example.md
  config_output: markdown
  plugin_activity: yes
...
with:
  ...
  markdown: >-
    https://raw.githubusercontent.com/cyberoslab/metrics/master/source/templates/markdown/example.pdf.md
